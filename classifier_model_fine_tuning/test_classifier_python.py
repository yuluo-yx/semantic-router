...
def predict_category(model_path, question, mapping_path="category_classifier_linear_model/category_mapping.json"):
...
def main():
    ...
    mapping_path = "category_classifier_linear_model/category_mapping.json"
    try:
    ...
    # Load the model
    model_path = "./category_classifier_linear_model"
